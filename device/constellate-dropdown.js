...
function paint(){
    ...
    var ink=name==='timing'&&Number(box.getattr('active'))===0?.45:0;
    mgraphics.select_font_face('Helvetica');mgraphics.set_font_size(12);mgraphics.set_source_rgba(ink,ink,ink,1);
